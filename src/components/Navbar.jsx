  ...
  return (
    <nav className="navbar-cyber" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
      <Link to="/" style={{ textDecoration: 'none', color: 'inherit', display: 'flex', alignItems: 'center', gap: '0.75rem', minWidth: 0, overflow: 'hidden', flexShrink: 1 }}>
        <span className="app-logo-mark navbar-logo-mark" style={{ width: 52, height: 50 }} aria-hidden="true" />
        <div style={{ minWidth: 0, overflow: 'hidden' }}>
          <h2 className="cyber-glitch-text" style={{ margin: 0, fontSize: '1rem', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>Career Development Center</h2>
